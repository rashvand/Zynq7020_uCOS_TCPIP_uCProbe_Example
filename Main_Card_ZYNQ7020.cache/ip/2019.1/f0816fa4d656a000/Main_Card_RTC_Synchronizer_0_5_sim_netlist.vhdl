...
\RTC_UNIX_Time[0]_i_2\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\RTC_UNIX_Time_reg[0]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 1) => RTC_UNIX_Time_reg(3 downto 1),
      S(0) => \RTC_UNIX_Time[0]_i_2_n_0\
    );
...
\RTC_UNIX_Time_reg[12]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => RTC_UNIX_Time_reg(15 downto 12)
    );
...
\RTC_UNIX_Time_reg[16]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => RTC_UNIX_Time_reg(19 downto 16)
    );
...
\RTC_UNIX_Time_reg[20]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => RTC_UNIX_Time_reg(23 downto 20)
    );
...
\RTC_UNIX_Time_reg[24]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => RTC_UNIX_Time_reg(27 downto 24)
    );
...
\RTC_UNIX_Time_reg[28]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => RTC_UNIX_Time_reg(31 downto 28)
    );
...
\RTC_UNIX_Time_reg[4]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => RTC_UNIX_Time_reg(7 downto 4)
    );
...
\RTC_UNIX_Time_reg[8]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => RTC_UNIX_Time_reg(11 downto 8)
    );
