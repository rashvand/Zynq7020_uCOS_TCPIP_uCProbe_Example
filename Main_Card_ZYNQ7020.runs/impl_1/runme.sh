...
HD_PWD='D:/Vebko/Relay/Relay_V3.0/Rev.02/Main_Card_Zynq7020/Main/Main_Card_ZYNQ7020/Main_Card_ZYNQ7020.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Main_Card_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Main_Card_wrapper.tcl -notrace
