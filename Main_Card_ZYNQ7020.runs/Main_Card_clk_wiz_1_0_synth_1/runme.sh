...
HD_PWD='D:/Vebko/Relay/Relay_V3.0/Rev.02/Main_Card_Zynq7020/Main/Main_Card_ZYNQ7020/Main_Card_ZYNQ7020.runs/Main_Card_clk_wiz_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Main_Card_clk_wiz_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Main_Card_clk_wiz_1_0.tcl
